...
Os novos [NVG-16](NVG-16-boot-vault-perde-parametros.md) e [NVG-27](NVG-27-vpn-ipv6-sem-ndp.md) afetam, respectivamente, **outro gerador de entrada de boot** e **a conectividade IPv6 com cache vazio**. Não são a reaparição do NVG-04 nem dos vazamentos NVG-10/11.
